...
import 'package:project/pages/show_user_page.dart';
...
class ShowMissionPage extends StatefulWidget {
  const ShowMissionPage(
  ...
  static Future<void> show(BuildContext context,
    ...
    await Navigator.of(context, rootNavigator: true).push(
      MaterialPageRoute(
        builder: (context) =>
            ShowMissionPage(database: database, mission: mission),
  ...
  State<StatefulWidget> createState() {
    return _ShowMissionPageState();
  }
}

class _ShowMissionPageState extends State<ShowMissionPage> {
      ...
      builder: (context, child) {
        return Scaffold(
          appBar: AppBar(
            elevation: 2.0,
            title:
                Text(widget.mission == null ? 'New Mission' : 'Show Mission'),
          ),
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                widgetChildren = [
                  UserListTile(
                      user: snapshot.data!,
                      onTap: () => ShowUserPage.show(context,
