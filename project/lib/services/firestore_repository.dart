...
class FirestoreRepository implements Repository {
  ...
  Stream<Iterable<Mission>> getAllMissionsStream() =>
      _getCollectionStream(ApiPaths.missionRoot(), Mission.fromMap);

  @override
  Stream<Mission?> getMissionStream(String missionId) =>
      _getDocumentStream(ApiPaths.mission(missionId), Mission.fromMap);

  Stream<T?> _getDocumentStream<T>(String path,
  ...
  Stream<Iterable<T>> _getCollectionStream<T>(String path,
      T Function(Map<String, dynamic>) converter) {
